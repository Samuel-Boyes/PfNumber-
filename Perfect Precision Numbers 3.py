...
#TODO: Refactor Mul,div,add and sub to return a new pnumber rather than modifying self.
#This works fine now, but potential improvements to performance:
#Don't need to multiply out denominator then recalc factors in addition/sub
#cache list of primes? Make it global so all pnumbers can access it.
#Remove factors before multiplying out numerator (check if both numerators + denominator have the factor in addition, before multiplying out and adding)

class pnumber:
    #Stores values for the number in terms of factors
    def __init__(self, numerator, denominator):
        ...
        #legacy code that has been moved to __storeValues
...
yy = pnumber(17,4) #x(i-1) or (y)
zz = pnumber(4,1)  #x(i-2) or (z)
print(yy.display())
print(yy.displayValue())
print(yy.getValue())
print()
print(zz.display())
print(zz.displayValue())
print(zz.getValue())
print()
